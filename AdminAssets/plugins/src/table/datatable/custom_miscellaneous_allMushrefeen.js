$(document).ready(function () {
    ...
    */
    ...
    var table = $("#show-hide-col-allMushrefeen").DataTable({
        dom:
        ...
        "createdRow": function(row, data, dataIndex) {
            // إزالة كلاس sorting من الأعمدة المحددة
            $('th:contains("حالة الطالب"), th:contains("رقم الهاتف"), th:contains("تاريخ الميلاد"), th:contains("التخصص العلمي"), th:contains("الجنس")').removeClass('sorting');
        },
        // أو يمكنك استخدام event listener لإزالة الكلاس عند الضغط
